...
export default function LinksPage() {
  ...
  const resetForm = () => {
    setForm({ domain_id: domains[0]?.id || '', slug: '', name: '', target_url: '', pixel_id: '', gtm_id: '', ga_id: '' })
    setFormError('')
    setTargets([])
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    ...
                    <button
                      ...
                      className={`text-xs px-3 py-1.5 rounded-lg transition ${link.is_active ? 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'
                        }`}
                    >
